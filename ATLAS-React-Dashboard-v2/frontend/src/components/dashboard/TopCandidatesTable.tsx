...
export function TopCandidatesTable({ rows }: { rows: Candidate[] }) {
  return (
    <section className="panel overflow-hidden">
      ...
      <p className="border-t border-outline-variant px-4 py-3 text-xs text-text-muted dark:border-slate-700 dark:text-slate-400">Docking scores are reported in kcal/mol. A dash (—) means no score is available.</p>
    </section>
  );
}
